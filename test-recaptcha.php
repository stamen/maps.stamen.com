    ...
    <body>
        <div id="header" class="navbar">
            <div class="navbar-inner">
                <h1 id="tiles" class="brand"><a id="home-link" href="../">maps.stamen.com</a> / <span id="current-provider">toner</span></h1>
                <a id="stamen" class="brand" href="http://stamen.com">stamen</a>
                <a id="toggle-feedback" class="brand toggler">report a bug</a>
            </div>
        </div>

        <div id="map-main" class="map" data-provider="toner">
            <p class="attribution">
        ...
        <script type="text/javascript" src="js/layer.js?recaptcha" defer></script>
    </body>
</html>
